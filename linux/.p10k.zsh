# Generated by Powerlevel10k configuration wizard on 2023-02-04 at 01:31 EST.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=138
  ...
  # (see below) that gets matched. If you unset all:q
